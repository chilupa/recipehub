-- Recipe cover images: DB column, public storage bucket, RLS, and feed/search RPCs.

alter table public.recipes
  add column if not exists image_url text;

-- ---------------------------------------------------------------------------
-- Storage: public bucket so feed/detail URLs work for guests and signed-in.
-- Object path: {user_id}/{recipe_id}.jpg (owner-only write).
-- ---------------------------------------------------------------------------
